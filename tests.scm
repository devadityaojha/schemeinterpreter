...
(quote (cs61a fall 2018 scheme project))
; expect (cs61a fall 2018 scheme project)
...
(quote (car (list 0 1 2)))
; expect (car (list 0 1 2))

`(list ,tau 2 4 cs61 a)
; expect (list 6.2831852 2 4 cs61 a)

(eval (cons 'cdr `('(2 4 ,(+ 3 4)))))
; expect (4 7)
...
(define quadruple_x (mu () (* 4 x)))
; expect quadruple_x

(define (define_2x) (define x 8) (quadruple_x))
; expect define_2x

(define_2x)
; expect 32

(define (getzero n) (if (zero? n) n (getzero (- n 1))))
; expect getzero
...
(define g (lambda () (define a 10) (define b 18) (f)))
; expect g
...
(define (bang n) (if (even? n) (/ n 2) (- n 1)))
; expect bang
